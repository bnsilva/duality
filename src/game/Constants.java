...
public class Constants {
	...
	public static float MAX_TIME_JUMPING = 100.0f;
	public static float MAX_TIME_DOUBLE_JUMPING = 80.0f;
	public static float JUMP_VELOCITY = -3.5f;
	
	public static float VEL_CAM = 2;
